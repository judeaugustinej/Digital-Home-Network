define(['components/home/module', 'nvd3'], function (module, nv) {
	
	'use strict';
	
    return module.registerDirective('nvd3', ['nvd3Utils', function(nvd3Utils){
		return {
			restrict: 'AE',
			scope: {
	...
	.registerFactory('nvd3Utils', function(){
		return {
